...
public interface SpellListCharacterRepository extends JpaRepository<SpellListChar, Long> {
    ...
    @Query("select t.spellList.id as id, t.spellList.spellName as spellName, t.spellList.description as description, t.spellList.level as level from SpellListChar t where t.charId = :id")
